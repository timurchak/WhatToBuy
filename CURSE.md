...
Click the **What To Buy** minimap button, use the addon menu beside the minimap, or type **/wtb** to browse anywhere. Drag the minimap button to move it; its position is saved. The window stays open when you leave the auction house.
